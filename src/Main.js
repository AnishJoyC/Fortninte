  ...
  return (
    <>
      ...
      <Container>
        ...
        <div className="pt-5">
          <h2 className="pt-5 text-center">Our Contribution</h2>
          <p className="subhead2 pt-3 text-center">
            Our core offering extends beyond mere profit generation; we
          ...
          <Row className="mt-5 pt-5 pb-5 justify-content-center">
            <Col md={4} className="text-center">
              <h3>5M</h3>
              <p className="pt-3 subhead3">Daily User Engagements</p>
            </Col>
            <Col md={4} className="text-center">
              <h3>$500K</h3>
              <p className="pt-3 subhead3">Revenue Surge for our Platform</p>
            </Col>
            <Col md={4} className="text-center">
              <h3>10X</h3>
              <p className="pt-3 subhead3">
        ...
        <div className="my-5">
          <h4 className="mt-5 pt-5 pb-3 text-center">
            Interested In Delving Deeper Into The Project?
          </h4>
          <p className="pb-5 subhead4 text-center">
            If you'd like to explore further details about our initiatives or
            ...
            at <span>+91 420 20802730.</span>
          </p>
          <div className="text-center">
            <Button className="SIgnupBtn mb-3">Sign up on Skype</Button>
            <Button className="ContactBTN mb-5">Contact Us</Button>
          </div>
        </div>
